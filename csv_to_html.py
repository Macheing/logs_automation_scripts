...
if __name__ == "__main__":
    main()
    # enter ./csv_to_html.py error_messages.csv error_messages.html
    # enter ./csv_to_html.py user_statistics.csv user_statistics.html
    # enter ./csv_to_html.py user_emails1.csv user_emails1.html
